...
final class SanitizrErrorMessages
{
    ...
    public const string STRING_MUST_START_WITH = "Does not start with required string";
    public const string STRING_MUST_END_WITH = "Does not end with required string";
}
